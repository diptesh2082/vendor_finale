...
class UpcomingBookings extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection('bookings').where("booking_status", isEqualTo: "u").where("vendorId", isEqualTo: "dipteshmandal555@gmail.com").snapshots(),
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          return document.isNotEmpty ?ListView.separated(
            ...
            separatorBuilder: (context, index) =>
                Divider(height: kDividerHeight, color: kDividerColor,),
          ) : Center(
            child: Text(
              "No Bookings",
              style: TextStyle(
